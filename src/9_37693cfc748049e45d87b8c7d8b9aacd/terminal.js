...
var Terminal = (function () {
	...
	promptInput = function (terminalObj, message, PROMPT_TYPE, callback) {
		...
		*/
		...
		//copy style
		inputField.style.cssText = document.defaultView.getComputedStyle(terminalObj.html, "").cssText;
		//inputField.style.background = "white";
		inputField.style.padding = "0px 0px 0px 10px";
		inputField.style.margin = "-0.8em 0px";
		...
		inputField.onkeydown = function (e) {
			...
			if (e.which === 38) {
				...
				if (tempCommand != lastCommand && i.value != lastCommand) {
					tempCommand = i.value
				}
				//terminalObj._inputLine.textContent = lastCommand
				i.value = lastCommand

				//================================================
				//TODO/FIXME: cursor is not placed at end of input
				//================================================

				var l = lastCommand.length
				i.setSelectionRange(l,l)

			//DownArrow Handling
			} else if ( e.which === 40 ) {

				//terminalObj._inputLine.textContent = tempCommand
				i.value = tempCommand
				var l = tempCommand.length
				i.setSelectionRange(l,l)
